...
var CreateAppointmentService = /** @class */ (function () {
    ...
    CreateAppointmentService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointmentsReporitory, appointmentDate, findAppointmentInSameDate, appointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        appointmentsReporitory = typeorm_1.getCustomRepository(AppointmentRepository_1.default);
                        appointmentDate = date_fns_1.startOfHour(date);
                        return [4 /*yield*/, appointmentsReporitory.findByDate(appointmentDate)];
                    case 1:
                        findAppointmentInSameDate = _b.sent();
                        if (findAppointmentInSameDate) {
                            throw new AppError_1.default("This appointment is already booked", 400);
                        }
                        appointment = appointmentsReporitory.create({
                            provider_id: provider_id,
                            date: appointmentDate,
                        });
                        return [4 /*yield*/, appointmentsReporitory.save(appointment)];
                    case 2:
                        _b.sent();

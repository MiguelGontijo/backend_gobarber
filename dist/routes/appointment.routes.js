...
appointmentsRouter.get('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var appointmentsReporitory, appointments;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                appointmentsReporitory = typeorm_1.getCustomRepository(AppointmentRepository_1.default);
                return [4 /*yield*/, appointmentsReporitory.find()];
            case 1:
                appointments = _a.sent();
                return [2 /*return*/, response.status(200).json(appointments)];
        }
    });
}); });
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, createAppointment.execute({ date: parseDate, provider_id: provider_id })];
            case 1:
                appointment = _b.sent();
